...
!(function (a) {
  for (
    var b =
      ...
      c = [],
      d = function (a) {
        return a.replace(/\ufe0f|\u200d/gm, "");
      },
      e = function (a) {
        for (var b = "", c = 0; c < a.length; c++)
          b += "\\u" + ("000" + a[c].charCodeAt(0).toString(16)).substr(-4);
        return b;
      },
      f = function (a) {
        for (var b = [], c = 0, d = 0, e = 0; e < a.length; )
          (c = a.charCodeAt(e++)),
            d
              ? (b.push(
                  (65536 + ((d - 55296) << 10) + (c - 56320)).toString(16)
                ),
                (d = 0))
              : c >= 55296 && 56319 >= c
              ? (d = c)
    ...
    c.push(e(b[g]));
  var h = new RegExp("(" + c.join("|") + ")", "g");
  (c = null), (b = null);
  var i = function (a, b, c, e, g) {
    return a.replace(h, function (a, h) {
      var i = '<img draggable="false"';
      return (
        (i += e ? ' class="' + e + '"' : ""),
        (i += c ? ' alt="' + h + '"' : ""),
        (i += ' src="' + b + f(d(h)) + "." + g + '">')
  ...
  (a.Emoji = function (b, c) {
    var d = this,
      e = a(b),
      b = b,
      f = { path: "img/apple40/", class: "emoji", alt: !0, ext: "png" };
    (d.settings = {}),
      (d.init = function () {
        (d.settings = a.extend({}, f, c)),
          e.html(
            i(
              e.html(),
              d.settings.path,
    ...
    (a.fn.Emoji = function (b) {
      return this.each(function () {
        if (void 0 == a(this).data("Emoji")) {
          var c = new a.Emoji(this, b);
          a(this).data("Emoji", c);
        }
      });
    });
