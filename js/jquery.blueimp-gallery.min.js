  ...
  return (
    d.extend(i.prototype, {
      ...
      support: (function (s) {
        ...
        function i() {
          ...
          document.body.appendChild(s),
            ...
            void 0 !== s.style.backgroundSize &&
              ((o.backgroundSize = {}),
              (s.style.backgroundSize = "contain"),
              (o.backgroundSize.contain =
                "contain" ===
                window.getComputedStyle(s).getPropertyValue("background-size")),
        ...
        window.clearTimeout(this.timeout),
          ...
          1 < this.elements[this.index] &&
            (this.timeout = this.setTimeout(
              ...
              [e, this.options.slideshowTransitionSpeed],
              this.interval
            )),
      ...
      close: function () {
        ...
        this.options.onclose && this.options.onclose.call(this),
          this.support.transition && this.options.displayTransition
            ? (this.container.on(this.support.transition.end, function t(e) {
        ...
        s
          ? ((o = this),
            ...
            (a = window.setInterval(function () {
              ...
              if (s < t)
                return (
                  (o.slidesContainer[0].style.left = i + "px"),
                  o.ontransitionend(),
                  void window.clearInterval(a)
                );
              o.slidesContainer[0].style.left =
      ...
      onmouseout: function (t) {
        ...
        this.touchStart &&
          ((e = t.target),
          ((i = t.relatedTarget) && (i === e || d.contains(e, i))) ||
            this.onmouseup(t));
      },
          ...
          if (
            ...
            for (
              t.preventDefault(),
                window.clearTimeout(this.timeout),
                this.options.continuous
                  ? (i = [this.circle(n + 1), n, this.circle(n - 1)])
                  : ((this.touchDelta.x = e /=
                      (!n && 0 < e) || (n === this.num - 1 && e < 0)
                        ? Math.abs(e) / this.slideWidth + 1
                        : 1),
                    (i = [n]),
                    n && i.push(n - 1),
                    n < this.num - 1 && i.unshift(n + 1));
              i.length;
      ...
      ontouchend: function (t) {
        ...
        var e,
          ...
          d =
            (h && 20 < Math.abs(this.touchDelta.x)) ||
            Math.abs(this.touchDelta.x) > r / 2,
          c =
            (!a && 0 < this.touchDelta.x) ||
            (a === this.num - 1 && this.touchDelta.x < 0),
          p =
            !d &&
            this.options.closeOnSwipeUpOrDown &&
            ((h && 20 < Math.abs(this.touchDelta.y)) ||
            ...
            ? ((i = a + e),
              ...
              this.options.continuous
                ? (this.move(this.circle(i), o, 0),
                  this.move(this.circle(a - 2 * e), n, 0))
                : 0 <= i && i < this.num && this.move(i, o, 0),
              this.move(a, this.positions[a] + o, l),
              this.move(this.circle(s), this.positions[this.circle(s)] + o, l),
              (a = this.circle(s)),
              this.onslide(a))
            : this.options.continuous
      ...
      oncomplete: function (t) {
        ...
        i &&
          ...
          d(s).removeClass(this.options.slideLoadingClass),
          "error" === t.type
            ? (d(s).addClass(this.options.slideErrorClass),
              (this.elements[e] = 3))
            : (this.elements[e] = 2),
      ...
      imageFactory: function (t, i) {
        ...
        return (
          "string" != typeof r &&
            ((r = this.getItemProperty(t, this.options.urlProperty)),
            (e = this.getItemProperty(t, this.options.titleProperty)),
            (n = this.getItemProperty(t, this.options.altTextProperty) || e)),
          !0 === h && (h = "contain"),
          (h =
            this.support.backgroundSize && this.support.backgroundSize[h] && h)
            ? (o = this.elementPrototype.cloneNode(!1))
            : ((o = l).draggable = !1),
          e && (o.title = e),
          n && (o.alt = n),
          d(l).on("load error", function t(e) {
            if (!s) {
              if (((e = { type: e.type, target: o }), !o.parentNode))
                return a.setTimeout(t, [e]);
              (s = !0),
                d(l).off("load error", t),
                h &&
                  "load" === e.type &&
                  ((o.style.background = 'url("' + r + '") center no-repeat'),
                  (o.style.backgroundSize = h)),
                i(e);
            }
          }),
          (l.src = r),
      ...
      createElement: function (t, e) {
        ...
        return (
          ...
          n && o.setAttribute("srcset", n),
          d(o).addClass(this.options.slideContentClass),
          o
        );
      },
      loadElement: function (t) {
        this.elements[t] ||
          (this.slides[t].firstChild
            ? (this.elements[t] = d(this.slides[t]).hasClass(
                this.options.slideErrorClass
              )
                ? 3
                : 2)
            : ((this.elements[t] = 1),
              d(this.slides[t]).addClass(this.options.slideLoadingClass),
      ...
      loadElements: function (t) {
        for (
          var e = Math.min(this.num, 2 * this.options.preloadRange + 1),
            i = t,
            s = 0;
          s < e;
          s += 1
      ...
      initSlides: function (t) {
        ...
        for (
          t ||
            ...
            d(this.slidePrototype).addClass(this.options.slideClass),
      ...
      getDataProperty: function (t, e) {
        ...
        if (
          ...
          if (
            /^(true|false|null|-?\d+(\.\d+)?|\{[\s\S]*\}|\[[\s\S]*\])$/.test(s)
          )
            try {
      ...
      initEventListeners: function () {
        ...
        d(window).on("resize", e),
          d(window).on("hashchange", e),
          d(document.body).on("keydown", e),
      ...
      destroyEventListeners: function () {
        ...
        d(window).off("resize", e),
          d(document.body).off("keydown", e),
      ...
      initWidget: function () {
        var i = this;
        return (
          (this.container = d(this.options.container)),
      ...
      initOptions: function (t) {
        (this.options = d.extend({}, this.options)),
          ((t && t.carousel) ||
            (this.options.carousel && (!t || !1 !== t.carousel))) &&
            d.extend(this.options, this.carouselOptions),
        ...
        createIndicator: function (t) {
          ...
          return (
            this.options.thumbnailIndicators &&
              (n && (e = this.getItemProperty(t, n)),
              void 0 === e &&
                (i = t.getElementsByTagName && a(t).find("img")[0]) &&
                (e = i.src),
              e && (s.style.backgroundImage = 'url("' + e + '")')),
            o && (s.title = o),
            s
          );
        },
    ...
    return (
      w.extend(t.prototype, {
        ...
        videoFactory: function (t, e, i) {
          ...
          if (
            (c.addClass(h.videoContentClass), f && (d.title = f), u.canPlayType)
          )
            if (m && y && u.canPlayType(y)) u.src = m;
            else if (C)
              for (; C.length; )
                if (
                  ((o = C.shift()),
                  (m = this.getItemProperty(o, h.urlProperty)),
                  (y = this.getItemProperty(o, h.typeProperty)),
                  m && y && u.canPlayType(y))
                ) {
                  u.src = m;
                  break;
          ...
          return (
            v &&
              ...
              w(s).addClass(h.toggleClass),
              (s.src = v),
              (s.draggable = !1),
              (s.alt = g),
              d.appendChild(s)),
            (n = document.createElement("a")).setAttribute("target", "_blank"),
            i || n.setAttribute("download", f),
            (n.href = m),
            u.src &&
              ((u.controls = !0),
              (i || w(u))
                ...
                .on("pause", function () {
                  u.seeking ||
                    ((a = !1),
                    c
                      .removeClass(r.options.videoLoadingClass)
                      .removeClass(r.options.videoPlayingClass),
                    l && r.container.addClass(r.options.controlsClass),
                    delete r.playingVideo,
                    r.interval && r.play());
                })
                .on("playing", function () {
                  (a = !1),
                    c
                      .removeClass(r.options.videoLoadingClass)
                      .addClass(r.options.videoPlayingClass),
                    r.container.hasClass(r.options.controlsClass)
                      ? ((l = !0),
                        r.container.removeClass(r.options.controlsClass))
                      : (l = !1);
                })
                .on("play", function () {
                  window.clearTimeout(r.timeout),
                    (a = !0),
                    c.addClass(r.options.videoLoadingClass),
                    (r.playingVideo = u);
                }),
              w(n).on("click", function (t) {
                r.preventDefault(t), a ? u.pause() : u.play();
              }),
              d.appendChild((i && i.element) || u)),
            d.appendChild(n),
            this.setTimeout(e, [{ type: "load", target: d }]),
            d
          );
        },
      }),
    ...
    return (
      ...
      t.extend(e.prototype, {
        ...
        textFactory: function (t, e) {
          ...
          return s
            ? (void 0 === this.getItemProperty(t, i.urlProperty) &&
                (t[i.urlProperty] = "//www.youtube.com/watch?v=" + s),
              void 0 === this.getItemProperty(t, i.videoPosterProperty) &&
                (t[i.videoPosterProperty] =
                  "//img.youtube.com/vi/" + s + "/maxresdefault.jpg"),
              this.videoFactory(
                t,
                e,
